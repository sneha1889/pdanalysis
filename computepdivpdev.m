function [startrowList,endrowList,pdivRow,pdevRow] = computepdivpdev(thresholdRowValue,frequencyPD, row_offset) 
...
disp(indexMax)
pdivRow = startrowList(indexMax)+row_offset;
